                                ...
                                <div class="row">
                                    ...
                                    <div class="span9" dir="auto">
                                        <ul class="breadcrumb">
                                            ...
                                            <li><a href="Home"><fmt:message key="home" /></a> <span class="divider">/</span></li>

                                            <c:if test="${language == 'en' }" >
                                                <li class="active">${requestScope.category}</li>
                                                </c:if>
                                                <c:if test="${language == 'ar' }" >
                                                <li class="active">${requestScope.arabicCategory}</li>
                                                </c:if>

                                        </ul>
                                        <c:if test="${language == 'en' }" >
                                            <h3> ${requestScope.category} <small class="pull-right"> ${requestScope.noOfProducts} <fmt:message key="availableProducts" /> </small></h3>
                                        </c:if>
                                        <c:if test="${language == 'ar' }" >
                                            <h3> ${requestScope.arabicCategory} <small class="pull-right"> ${requestScope.noOfProducts} <fmt:message key="availableProducts" /> </small></h3>
                                        </c:if>
                                            ...
                                            <div class="tab-pane  active" id="blockView">
                                                ...
                                                <ul class="thumbnails">
                                                    <c:forEach items="${list}" var="product" >
                                                        ...
                                                        <li class="span3">
                                                            <div class="thumbnail" >
                                                                <a href="${productDetailsURL}"><img src="themes/images/products/3.jpg" alt=""/></a>
                                                                <div class="caption">
                                                                    <c:if test="${language == 'en' }" >
                                                                    ...
                                                                    <script>
                                                                        $(document).on("click", "#somebtn${product.productId}", function () { // When HTML DOM "click" event is invoked on element with ID "somebutton", execute the following function...
                                                                            $.get("${CartURL}", function (responseText) {   // Execute Ajax GET request on URL of "someservlet" and execute the following function with Ajax response text...
                                                                    ...
                                                                    <h4 style="text-align:center">
                                                                        ...
                                                                        <button type="submit" id="somebtn${product.productId}" class="btn">
                                                                            <fmt:message key="addTo" />
                                        ...
                                        <div class="pagination">
                                            <ul>
                                                ...
                                                <c:url value="Products" var="nextURL" >
                                                    ...
                                                    <c:param name="pageNo" value="${nextPage}" ></c:param>
                                                </c:url>
                                                <c:url value="Products" var="prevURL" >
                                                    <c:param name="category" value="${category}" ></c:param>
                                                    <c:param name="pageNo" value="${prevPage}" ></c:param>
                                                </c:url>

                                                <c:set var="prevLimit" value="${0}" />

                                                <c:if test="${prevPage > prevLimit}" >
                                                    <li><a href="${prevURL}">&lsaquo;</a></li> 
                                                    </c:if>



                                                <c:forEach begin="1" end="${totalPagesNo}" var="i" >
                                                    <c:url value="Products" var="products" >
                                                        <c:param name="category" value="${category}" ></c:param>
                                                ...
                                                <c:if test="${nextPage <= totalPagesNo}" >
