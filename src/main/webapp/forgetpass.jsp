                                ...
                                <div class="row">
                                    ...
                                    <div class="span9" dir="auto">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><fmt:message key="forgetPassword" /></li>
                                        </ul>
                                        <h3> <fmt:message key="forgetPassword" /></h3>	
                                        <hr class="soft"/>

                                        <div class="row">
                                            <div class="span9" style="min-height:500px">
                                                <div class="well">
                                                    <h5><fmt:message key="resetPass" /></h5><br/>
                                                    <fmt:message key="resendPass" /><br/><br/><br/>
                                                    <form>
                                                        <div class="control-group">
                                                            <label class="control-label" for="inputEmail1"><fmt:message key="EmailAddress" /></label>
                                                            <div class="controls">
                                                                <input class="span3"  type="text" id="inputEmail1" placeholder="<fmt:message key="EmailAddress" />">
                                                            </div>
                                                        </div>
                                                        <div class="controls">
                                                            <button type="submit" class="btn block"><fmt:message key="submit" /></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
