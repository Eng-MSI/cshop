                                        ...
                                        <div class="row">
                                            <div class="span9" style="min-height:500px">
                                                <div class="well">
                                                    ...
                                                    press resend if you didn't recieve a verification email . A verification code will be sent to you. Once you have received the verification code, press the activation link to activate your account.<br/><br/><br/>
                                                    

                                                        <div class="controls">
                                                            <a href="ActivationMail" class="btn block">Resend</a>
                                                        </div>
