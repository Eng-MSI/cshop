                                ...
                                <div class="row">
                                    ...
                                    <div class="span9" >
                                        <ul class="breadcrumb"dir="auto">
                                            ...
                                            <li class="active"><fmt:message key="searchResults" /></li>
                                        </ul>
                                        <h3 dir="auto"><small class="pull-right"> ${fn:length(lits)+1} <fmt:message key="products" /> </small>	</h3><br>
                                        <h3 dir="auto"><fmt:message key="searchResultFor" /> "${requestScope.searchString}" </h3>
                                        <hr class="soft"/>
