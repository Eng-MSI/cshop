                                        ...
                                        <div class="well">
                                            ...
                                            <form name="form" method="post"  class="form-horizontal" action="Regsiter" onsubmit="return !!(ValidateEmail() & ValidateFirstName(document.form.firstName) & ValidateLastName(document.form.lastName) & ValidateFirstPass() & ValidateSecondPass());" >
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text" name="firstName" id="inputFname1" placeholder="<fmt:message key="firstName" />" onblur="return ValidateFirstName(document.form.firstName);" value="${requestScope.user.userId}" >
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select id="city" name="city" >
                                                            <option value="Kuwait">Kuwait</option>
                                                            <option value="Hawally">Al-Hawally</option>
                                                            <option value="Farwaniya">Al-Farwaniya</option>
                                                            <option value="AlJahra">Al-Jahra</option>
                                                            <option value="Mubarak_AlKabeer">Mubarak Al-Kabeer</option>
                                                        </select>
                                                    </div>
                                                </div>	
