                                ...
                                <div class="row">
                                    ...
                                    <div class="span9" dir="auto">
                                        ...
                                        <div class="span4" style="
                                            ...
                                            <div class="span4 ">
                                                <div class="well">
                                                    <h5><fmt:message key="alreadyRegistered" /></h5>
                                                    <form action="Login" method="post" >
                                                        <div class="control-group">
                                                            <label class="control-label" for="inputEmail1"><fmt:message key="email" /></label>
                                                            <div class="controls">
                                                                <input class="span3"  type="text" id="inputEmail1" name="email" placeholder="<fmt:message key="email" />">
                                                            </div>
                                                        </div>
                                                        <div class="control-group">
                                                            <label class="control-label" for="inputPassword1"><fmt:message key="password" /></label>
                                                            <div class="controls">
                                                                <input type="password" class="span3"  id="inputPassword1" name="password" placeholder="<fmt:message key="password" />">
                                                            </div>
                                                        </div>
                                                        <div class="control-group">
                                                            <div class="controls">
                                                                <button type="submit" class="btn"><fmt:message key="signIn" /></button> <a href="forgetpass.jsp"><fmt:message key="forgetPassword" /></a>
                                                            </div>
                                                        </div>
                                                    </form>
                                                    <h5><fmt:message key="dontHaveAcc" /></h5>
                                                    <a href="register.jsp"><fmt:message key="signUp" /></a>
                                                </div>
                                            </div>
