            ...
            <div class="well">
                ...
                <form action="j_security_check" method="post" >
                    <div class="control-group">
                        <label class="control-label" for="input_j_username">Admin User: </label>
                        <div class="controls">
                            <input class="span3"  type="text" id="input_j_username" name="j_username" placeholder="Admin User">
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label" for="input_Password">Password</label>
                        <div class="controls">
                            <input type="password" class="span3"  id="input_Password" name="j_password" placeholder="Password">
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="controls">
